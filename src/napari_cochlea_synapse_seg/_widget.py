...
class SynapSegWidget(QWidget):
    ...
    def _save_settings(self):
        """
        Save all widget settings to user config file.
        """
    ...
    def _save_settings_silent(self):
        """
        Save settings without showing notifications (for auto-save on exit).
        """
        try:
            settings = {
                'version': '1.0',
    ...
    def _load_settings(self, load_path=None):
        """
        Load all widget settings from user config file.
        """
